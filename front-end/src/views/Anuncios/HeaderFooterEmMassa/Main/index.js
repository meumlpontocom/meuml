...
export default function MainHeaderFooter({ history }) {
  ...
  const TextArea = ({ icon, title, errorFocus, ...rest }) => (
    <InputGroup>
      ...
      <Input type="textarea" rows="5" {...rest}></Input>
    </InputGroup>
  );
            ...
            <>
              <div className="col-12 mb-2 mt-2">
                <Controller
                  as={
                    <TextArea
                      icon="cil-border-top mr-1"
                      title="Cabeçalho"
                      placeholder="Digite aqui o texto para todos os cabeçalhos"
              ...
              <div className="col-12">
                <Controller
                  as={
                    <TextArea
                      icon="cil-border-bottom mr-1"
                      title="Rodapé"
                      placeholder="Digite aqui o texto para todos os rodapés"
                      errorFocus={errors.footer}
                    />
                  }
                  control={control}
                  name="footer"
